...
classification_tasks_num_labels = {"imdb": 2, "imdb-adv":2, "mr": 2,
                                   'mnli': 3, 'mnli-adv':3,
                                   'mr-adv': 2, 'sst': 2, 'sst-adv':2,
                                   'sst-pair':2,'mr-pair':2,'cr-pair':2,"cr": 2
                                   ,"agnews-adv":4}
...
class MnliProcessorAdv(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        csv.field_size_limit(500 * 1024 * 1024)
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "test.tsv")), "dev_matched")
...
classification_processors = {'imdb': IMDBProcessor, 'imdb-adv':IMDBProcessorAdv, 'mr': MRProcessor, 'mnli': MnliProcessor,
                             "mnli-mm": MnliMismatchedProcessor,"agnews-adv":agnews,
