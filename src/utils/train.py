...
class Trainer:
    ...
    def compute_loss(self, model, inputs):
        ...
        #outputs = model.forward_adv(outputs1,input_ids=inputs["input_ids"],attention_mask=inputs['attention_mask'],token_type_ids=inputs['token_type_ids'],
    ...
    def prediction_step(
        ...
        with (torch.no_grad()):
            outputs = model.forward_infer(**inputs)##改的
            if has_labels:
